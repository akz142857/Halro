...
export interface MFAStatus { enabled: boolean; policy: "optional" | "required" | "administrators_required"; required: boolean; authenticators: MFAAuthenticator[]; recovery_codes_remaining?: number }
