      ...
      {mfaSetupRequired ? <div className="settings-pane"><MFASettings /></div> : (
        <div className="settings-shell">
          ...
          <div className="settings-pane">
            ...
            {!pending && !error && pane === "general" && uiSettings.data && preferences.data && <section aria-labelledby="general-title"><SettingsGroupHeader title={t("settings.panes.general")} description={t("settings.generalDescription")} id="general-title" /><PersonalLanguageForm ui={uiSettings.data.data} preferences={preferences.data.data} /></section>}
...
function PersonalLanguageForm({ ui, preferences }: { ui: InstanceUISettings; preferences: AdminPreferences }) {
  ...
  const preferenceMutation = useMutation({
    mutationFn: (value: LocalePreference) => api.updatePreferences(value, preferences.revision),
