...
export function localizedError(t: TFunction, error: unknown) {
  ...
  const codeMessages: Record<string, string> = {
    ...
    provider_egress_proxy_idempotency_replay: "errors.providerEgressProxyIdempotencyReplay",
    ...
    provider_egress_proxy_not_found: "errors.providerEgressProxyNotFound",
    provider_egress_change_locked_by_deployments: "errors.providerEgressChangeLocked",
    provider_egress_proxy_change_locked_by_deployments: "errors.providerEgressProxyChangeLocked",
    provider_egress_proxy_in_use: "errors.providerEgressProxyInUse",
    provider_egress_proxy_limit: "errors.providerEgressProxyLimit",
    provider_egress_auth_invalid: "errors.providerEgressAuthInvalid",
    provider_test_deployment_invalid: "errors.providerTestDeploymentInvalid",
    provider_test_requires_all_bindings: "errors.providerTestRequiresAllBindings",
    ...
    capability_detection_capabilities_required: "errors.capabilityDetectionCapabilitiesRequired",
...
export function errorDetail(error: unknown) {
  ...
  const localizedWorkflowCodes = [
    ...
    "provider_egress_proxy_not_found",
    "provider_egress_change_locked_by_deployments",
    ...
    "capability_detection_capabilities_required",
    ...
    "provider_egress_proxy_idempotency_replay",
    ...
    "provider_egress_proxy_change_locked_by_deployments",
    "provider_egress_proxy_in_use",
    "provider_egress_proxy_limit",
    "provider_egress_auth_invalid",
    "provider_test_deployment_invalid",
    "provider_test_requires_all_bindings",
  ];
