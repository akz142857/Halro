export const zhCN = {
  ...
  auth: {
    ...
    mfaEyebrow: "二次验证", mfaHeading: "验证你的身份", mfaPrompt: "请输入身份验证器当前显示的动态验证码，验证码通常每 30 秒更新一次。", authenticatorCode: "身份验证器验证码", recoveryCode: "恢复码", verify: "验证", useRecovery: "使用恢复码", useAuthenticator: "使用身份验证器验证码", backToPassword: "返回密码登录",
  ...
  settings: {
    ...
    revokeAuthenticator: "撤销", confirmRevoke: "撤销身份验证器", otherAuthenticatorHint: "如有其他验证器，请使用另一台验证器批准", regenerateRecovery: "生成新的恢复码",
    runtimeTitle: "运行时设置",
