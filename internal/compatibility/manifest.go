...
// rather than of any profile — which is why they were identical in fourteen
// coverage rows, and why one of those rows had drifted and declared only two of
// them.
//
