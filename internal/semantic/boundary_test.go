...
func TestExportedCanonicalSchemaMatchesReviewedSnapshot(t *testing.T) {
	want := map[string][]string{
		...
		"Usage":            {"InputTokens=input_tokens", "OutputTokens=output_tokens", "ReasoningTokens=reasoning_tokens", "AudioTokens=audio_tokens", "TotalTokens=total_tokens", "Source=source"},
