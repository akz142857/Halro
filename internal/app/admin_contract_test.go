...
func TestFrozenV1AdminRoutesAreRegistered(t *testing.T) {
	...
	expected := []string{
		...
		"GET /admin/api/v1/projects/{}/outcome-definitions", "POST /admin/api/v1/projects/{}/outcome-definitions", "POST /admin/api/v1/projects/{}/outcome-definitions/{}/versions",
		...
		"GET /admin/api/v1/governance/outcomes", "GET /admin/api/v1/governance/summary", "POST /admin/api/v1/governance/export",
