...
清单共 32 项，**已完成 29 项**（逐条到代码里核实过，非仅凭本文件记录）：

| 档位 | 完成 / 总数 | 提交 |
|---|---|---|
| P0 | **5 / 5** | `897894e` |
| P1 | **10 / 10** | `8e373fb`、`e41446a`、`9c038b5`、`4bb3fc2` |
| P2 | **14 / 17** | `093ff1a`、`70d107d`、`c9528ab`、`18ff5d5`、`863adc2`、`97befaf` |

P1 已全部完成。P2 完成十四项，余三项：`P2-20`（`metricsauth` 改名）、`P2-29`（视觉）、`P2-30`（交互）。
...
| P2-20/29/30 | `metricsauth` 改名、视觉、交互 | 未开始 |
