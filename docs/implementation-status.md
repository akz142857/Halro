...
| Prometheus/Grafana observability | versioned independently revocable Metrics credentials, dedicated mTLS listener, bounded scrape rendering, Ledger-replay-safe classic latency histograms, build/runtime/capacity metrics, low-cardinality contract tests, pinned Prometheus/Alertmanager/Grafana provisioning, four dashboards, recording/alert rules, rule fixtures, capacity/security contracts and operations runbook |
