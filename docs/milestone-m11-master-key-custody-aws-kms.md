...
| M11-PR6 | Doctor、Backup、Restore 与 DR | In Progress | PR4、PR5 | 完整/静态 doctor；备份 manifest；KMS restore；真实 Recovery Slot 恢复演练 | [#62](https://github.com/akz142857/Heimdall/issues/62)；`docs/evidence/m11-06-kms-dr-2026-08-03.md` | 本地实现进行中；真实 AWS 与独立操作者证据待补 |
