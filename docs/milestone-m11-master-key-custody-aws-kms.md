...
| M11-PR2 | Key Slot descriptor 与状态机 | In Review | PR1 | pending/active/retiring/revoked 事务、revision/CAS、真实 Vault Key Check、COW kill points、compaction 和错误测试 | [#57](https://github.com/akz142857/Heimdall/issues/57)；[PR #65](https://github.com/akz142857/Heimdall/pull/65)；`510581a` | 完整 Test、定向 Race、Vet 与 provider-neutral 依赖检查通过；堆叠于 PR #64 |
