...
| M11-PR3a | AWS SDK spike、契约评审与 ADR 决策 | In Review | PR1 | A/B module/binary/container/build/test/cold-start/SBOM/vuln 实测；KMSWrapper/错误分类；fake KMS fault tests；ADR 0010 Accepted | [#58](https://github.com/akz142857/Heimdall/issues/58)；[PR #66](https://github.com/akz142857/Heimdall/pull/66)；`512d517`、`258c430`、`a964872` | 选择单 module/单 `heimdall` artifact；未知错误 fail closed；不含生产 AWS Adapter；完整 Test、Race、Vet、vuln 与边界检查通过 |
