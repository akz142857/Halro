...
Decrypt with the versioned Heimdall Encryption Context, verifies the fixed
...
```sh
export HEIMDALL_AWS_KMS_KEY_ARN='arn:aws:kms:REGION:ACCOUNT:key/KEY-ID'
...
long-lived access-key fields in Heimdall configuration.
