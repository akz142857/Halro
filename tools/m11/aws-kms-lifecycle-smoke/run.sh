...
: "${HEIMDALL_AWS_KMS_REPLACEMENT_PRIMARY_KEY_ARN:?set an existing replacement primary customer-managed KMS Key ARN}"

HEIMDALL_AWS_KMS_LIFECYCLE_REAL=1 \
  GOCACHE="${GOCACHE:-/tmp/heimdall-m11-kms-lifecycle-gocache}" \
