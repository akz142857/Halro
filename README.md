...
```bash
docker pull ghcr.io/akz142857/halro:v0.4.0
docker pull ghcr.io/akz142857/halro-deadman:v0.4.0   # the independent watchdog, deployed separately
```
...
docker run --rm --user 65532:65532 \
  ...
  ghcr.io/akz142857/halro:v0.4.0 init --config /etc/halro/config.yaml
```
...
docker run -d --name halro --user 65532:65532 \
  ...
  ghcr.io/akz142857/halro:v0.4.0 serve --config /etc/halro/config.yaml \
